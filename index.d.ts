export declare const Modal: (({ isOpen, close, children, position, size, backdropType, shadow, animation, }: import('./types/common').StrictPropsWithChildren<import('./Modal/types/Modal.type').ModalProps>) => import('../../node_modules/react').ReactPortal | null) & {
    Title: ({ children }: {
